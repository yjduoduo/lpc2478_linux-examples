...
int kernel_execve(const char *filename, char *const argv[], char *const envp[])
{
	 ...
	 */
	// regs.ARM_r0 = ret; => start_thread() in include/asm-arm/processor.h already do that
	// NOte that ret==0 when do_execve is succesfull
	regs.ARM_lr = (unsigned long)do_exit;
