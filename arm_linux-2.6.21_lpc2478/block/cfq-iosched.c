...
static  int cfq_fifo_expire[2] = { 0, 0 };
static const int cfq_back_max = 16 * 1024;	/* maximum backwards seek, in KiB */
static const int cfq_back_penalty = 2;		/* penalty of a backwards seek */

static  int cfq_slice_sync = 0;
static int cfq_slice_async = 0;
...
static int __init cfq_init(void)
{
	...
	cfq_fifo_expire[0] = HZ / 4;
	cfq_fifo_expire[1] = HZ / 8;
	cfq_slice_sync = HZ / 10;
	cfq_slice_async = HZ / 25;
	cfq_slice_idle = HZ / 125;
