...
static unsigned int scsi_inq_timeout = (2*100)/100+3;/*SCSI_TIMEOUT/HZ+3;*/
			  ...
			  int result_len, int *bflags)
{
	...
	static char scsi_inq_timeout_flag = 1;
	
	if (scsi_inq_timeout_flag == 1)
	{
		scsi_inq_timeout = SCSI_TIMEOUT/HZ+3;
		scsi_inq_timeout_flag = 0;
	}
