...
extern void device_set_wakeup_enable(struct device *dev,unsigned val);
extern int device_may_wakeup(struct device *dev);
...
extern void suspend_report_result(void *fn, int ret);
#if 0
#ifdef CONFIG_PM
extern suspend_disk_method_t pm_disk_mode;
