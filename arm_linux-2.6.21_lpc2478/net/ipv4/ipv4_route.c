...
static int ip_rt_min_delay		= 2 * 100;
static int ip_rt_max_delay		= 10 * 100;
static int ip_rt_max_size;
static int ip_rt_gc_timeout		= 300 * 100;
static int ip_rt_gc_interval		= 60 * 100;
static int ip_rt_gc_min_interval	= 100 / 2;
static int ip_rt_redirect_number	= 9;
static int ip_rt_redirect_load		= 100 / 50;
static int ip_rt_redirect_silence	= ((100 / 50) << (9 + 1));
static int ip_rt_error_cost		= 100;
static int ip_rt_error_burst		= 5 * 100;
static int ip_rt_gc_elasticity		= 8;
static int ip_rt_mtu_expires		= 10 * 60 * 100;
static int ip_rt_min_pmtu		= 512 + 20 + 20;
static int ip_rt_min_advmss		= 256;
static int ip_rt_secret_interval	= 10 * 60 * 100;
...
static int rt_garbage_collect(void)
{
	...
	static unsigned char expire_flag = 1;
