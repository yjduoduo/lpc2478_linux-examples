...
{
	static char unix_cred_cache_init_flag = 1;
	if (unix_cred_cache_init_flag == 1)
	{
		unix_cred_cache.expire = UNX_CRED_EXPIRE;
		unix_cred_cache_init_flag = 0;
	}
