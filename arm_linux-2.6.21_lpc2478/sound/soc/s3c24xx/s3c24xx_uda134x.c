...
{
	s3c2410_gpio_setpin(s3c24xx_uda134x_l3_pins->l3_data, v > 0);
	/*gpio_set_value(s3c24xx_uda134x_l3_pins->l3_data, v > 0);*/
}

static void setclk(int v)
{
	s3c2410_gpio_setpin(s3c24xx_uda134x_l3_pins->l3_clk, v > 0);
	/*gpio_set_value(s3c24xx_uda134x_l3_pins->l3_clk, v > 0);*/
}

static void setmode(int v)
{
	s3c2410_gpio_setpin(s3c24xx_uda134x_l3_pins->l3_mode, v > 0);
